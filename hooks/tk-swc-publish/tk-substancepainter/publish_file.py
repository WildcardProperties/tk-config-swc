...
class SubstancePainterFilePublishPlugin(HookBaseClass):
    """
    ...
    def settings(self):
        ...
        base_settings = super(SubstancePainterFilePublishPlugin, self).settings or {}
    ...
    def item_filters(self):
        ...
        """
        return ["substancepainter.session", "substancepainter.texture", "file.texture"]
    ...
    def validate(self, settings, item):
        ...
        return super(SubstancePainterFilePublishPlugin, self).validate(
            settings, item
        )
    ...
    def publish(self, settings, item):
        ...
        super(SubstancePainterFilePublishPlugin, self).publish(settings, item)
    ...
    def finalize(self, settings, item):
        ...
        super(SubstancePainterFilePublishPlugin, self).finalize(settings, item)
